...
Ticket conventions: every ticket lists objective, context, dependencies, invariants, acceptance criteria, tests, file scope, out-of-scope, definition of done (DoD). Work outside a ticket's file scope requires escalation, not improvisation ([CLAUDE.md](CLAUDE.md)).

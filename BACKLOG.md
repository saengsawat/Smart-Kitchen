...
#### M3-E0 tickets (written 2026-09-15 per PO; **not dispatched** — awaiting PO go; docs-only, no cost)

#### M3-E0-T1 — Prototype completion: missing MVP screens and non-happy states (design, docs only)
...
#### M3-E0-T3 — Token sheet finalisation: contrast measurements and scarcity audit (docs only)

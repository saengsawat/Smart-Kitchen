...
| M1-T11 | *(found by M1-T9 review)* aborted-transaction COMMIT silently discards ledger work | Opus / Opus | **dispatching** (D-018a) |
| M3-E0-T1 ∥ T2 | Prototype completion · safety copy deck (docs only) | Sonnet / Opus | queued after M1-T11 (parallel) |
